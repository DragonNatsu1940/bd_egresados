                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-secondary mb-1"><?= $this->session->userdata('specialization') ?></p>
                                    <p class="text-muted font-size-sm"><?= $this->session->userdata('profession') ?></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    <h4><?= $this->session->userdata('name') ?></h4>
                                    <p class="text-secondary mb-1"><?= $this->session->userdata('company_name') ?></p>
                                    <p class="text-muted font-size-sm"><?= $this->session->userdata('nit') ?></p>
                                    <!-- <button class="btn btn-primary">Follow</button>
                                    <button class="btn btn-outline-primary">Message</button> -->
                                </div>
                            </div>
