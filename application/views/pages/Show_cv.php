			    ...
			    <div class="media flex-column flex-md-row">
				    ...
				    <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
					    <div class="primary-info">
						    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase"><?= $this->session->userdata('name') ?>  <?= $this->session->userdata('last_name') ?></h1>
						    <div class="title mb-3"><?= $this->session->userdata('specialization') ?></div>
						    <ul class="list-unstyled">
							    <li class="mb-2"><a href="#"><i class="far fa-envelope fa-fw mr-2" data-fa-transform="grow-3"></i><?= $this->session->userdata('email') ?></a></li>
							    <li><a href="#"><i class="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i><?= $this->session->userdata('phone') ?></a></li>
						    </ul>
					    </div><!--//primary-info-->
